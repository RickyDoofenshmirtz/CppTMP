...
namespace fire {
    ...
    /*
    for the class to work for all type instead of just type_list we can use
    template template parameters as a container type by adding following as
    first parameter
    ...
    */
    ...
    static_assert(
        std::is_same_v<push_back_t<type_list<>, int>, type_list<int>>);
    static_assert(std::is_same_v<
    ...
    //////////////////////////////////////////////////////////////////////////////////////
    // any
    // template template parameters can also be used as actual inputs to
    // algorithms
    ...
    static_assert(
        !any_v<std::is_integral, type_list<std::string, double, float>>);
